...
{
    public partial class FrmManFamilia : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_mae_familia objRegistros = new CN_mae_familia();
        ...
        // ENTIDADES LOCALES
        BE_MAE_FAMILIA BE_ListaReg = new BE_MAE_FAMILIA();
        BE_MAE_FAMILIA BE_Registro = new BE_MAE_FAMILIA();
        ...
        public FrmManFamilia()
        {
            InitializeComponent();
        }

        private void FrmManFamilia_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(8, ref arrCabeceraDg1);
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            CboTipExi.SelectedValue = BE_Registro.n_id;
        ...
        private void FrmManFamilia_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManFamilia_Resize(object sender, EventArgs e)
        {
