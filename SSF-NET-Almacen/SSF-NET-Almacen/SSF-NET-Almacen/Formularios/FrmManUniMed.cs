...
{
    public partial class FrmManUniMed : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_sun_unimed objRegistros = new CN_sun_unimed();
        ...
        // ENTIDADES LOCALES
        BE_SUN_UNIMED BE_ListaReg = new BE_SUN_UNIMED();
        BE_SUN_UNIMED BE_Registro = new BE_SUN_UNIMED();
        ...
        private void FrmManUniMed_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(6, ref arrCabeceraDg1);
        }
        void ListarItems()
        {
        ...
        bool CamposOK()
        {
            ...
            if (TxtAbr.Text == "")
            {
                MessageBox.Show("¡ No ha especificado la abreviatura de la unidad de medida !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            return booEstado;
        ...
        private void FrmManUniMed_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManUniMed_Resize(object sender, EventArgs e)
        {
