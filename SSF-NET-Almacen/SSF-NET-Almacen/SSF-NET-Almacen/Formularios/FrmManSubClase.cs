...
{
    public partial class FrmManSubClase : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_mae_subclase objRegistros = new CN_mae_subclase();
        ...
        // ENTIDADES LOCALES
        BE_MAE_SUBCLASE BE_ListaReg = new BE_MAE_SUBCLASE();
        BE_MAE_SUBCLASE BE_Registro = new BE_MAE_SUBCLASE();
        ...
        public FrmManSubClase()
        {
            InitializeComponent();
        }

        private void FrmManSubClase_Load(object sender, EventArgs e)
        {
            booCargando = true;
            CargarCombos();
        ...
        void CargarCombos()
        {
            ...
            funDatos.ComboBoxCargarDataTable(CboCla, dtClase, "n_id", "c_des");
        }
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(10, ref arrCabeceraDg1);
            ...
            dtClase = objClase.Listar(STU_SISTEMA.EMPRESAID, STU_SISTEMA.SYS_UNIBD);
        }
        void ListarItems()
        {
        ...
        private void FrmManSubClase_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManSubClase_Resize(object sender, EventArgs e)
        {
        ...
        private void CboFam_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            {
                string strCadenaFiltro = "n_idfam = " + CboFam.SelectedValue.ToString() + "";

                DtFiltro = funDatos.DataTableFiltrar(dtClase, strCadenaFiltro);
                funDatos.ComboBoxCargarDataTable(CboCla, DtFiltro, "n_id", "c_des");
            }
        }
    }
}
