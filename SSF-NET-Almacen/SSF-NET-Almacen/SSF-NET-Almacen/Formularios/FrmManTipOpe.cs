...
{
    public partial class FrmManTipOpe : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_sun_tipope objRegistros = new CN_sun_tipope();
        ...
        // ENTIDADES LOCALES
        BE_SUN_TIPOPE BE_ListaReg = new BE_SUN_TIPOPE();
        BE_SUN_TIPOPE BE_Registro = new BE_SUN_TIPOPE();
        ...
        private void FrmManTipOpe_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void ConfigurarFormulario()
        {
            this.Height = 587;
            this.Width = 930;
            this.Text = "MANTENIMIENTO - TIPO DE OPERACION";
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(11, ref arrCabeceraDg1);
        }
        void ListarItems()
        {
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            if (BE_Registro.n_tipmov == 1) { OptIng.Checked = true; }
            if (BE_Registro.n_tipmov == 2) { OptSal.Checked = true; }
        }
        void Nuevo()
        {
            n_QueHace = 1;
        ...
        void AsignarEntidad()
        {
            ...
            if (OptIng.Checked == true) { BE_ListaReg.n_tipmov = 1; }
            if (OptSal.Checked == true) { BE_ListaReg.n_tipmov = 2; }
        }
        bool CamposOK()
        {
            bool booEstado = true;
        ...
        private void FrmManTipOpe_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManTipOpe_Resize(object sender, EventArgs e)
        {
