...
{
    public partial class FrmManMedioPago : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_tes_mediopago objRegistros = new CN_tes_mediopago();
        ...
        // ENTIDADES LOCALES
        BE_TES_MEDIOPAGO BE_Registro = new BE_TES_MEDIOPAGO();
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(69, ref arrCabeceraDg1);

            objForm.mysConec = mysConec;                                    // CARGAMOS LOS DATOS DEL FORMULARIO
            dtForm = objForm.TraerRegistro(69);
        }
        void ListarItems()
        {
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            {
                BE_Registro = objRegistros.entMedioPago;
        ...
        private void FrmManMedioPago_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManMedioPago_Load(object sender, EventArgs e)
        {
            booAgregando = true;
            CargarCombos();
