...
{
    public partial class FrmManDestino : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_tes_destino objRegistros = new CN_tes_destino();
        ...
        // ENTIDADES LOCALES
        BE_TES_DESTINO BE_Registro = new BE_TES_DESTINO();
        ...
        public FrmManDestino()
        {
            InitializeComponent();
        }

        private void FrmManDestino_Load(object sender, EventArgs e)
        {
            booAgregando = true;
            CargarCombos();
        ...
        private void FrmManDestino_Activated(object sender, EventArgs e)
        {
