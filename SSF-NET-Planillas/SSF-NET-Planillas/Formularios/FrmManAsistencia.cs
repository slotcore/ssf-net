...
{
    public partial class FrmManAsistencia : Form
    {
        // VARIABLES PUBLICAS
        ...
        public FrmManAsistencia()
        {
            InitializeComponent();
        }

        private void FrmManAsistencia_Load(object sender, EventArgs e)
        {
            booAgregando = true;
            CargarCombos();
        ...
        private void FrmManAsistencia_Activated(object sender, EventArgs e)
        {
