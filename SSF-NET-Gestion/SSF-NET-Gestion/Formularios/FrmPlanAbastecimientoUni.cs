...
{
    public partial class FrmPlanAbastecimientoUni : Form
    {
        // VARIABLES PUBLICAS
        ...
        public FrmPlanAbastecimientoUni()
        {
            InitializeComponent();
        }

        private void FrmPlanAbastecimientoUni_Load(object sender, EventArgs e)
        {
            booAgregando = true;
            CargarCombos();
        ...
        private void FrmPlanAbastecimientoUni_Activated(object sender, EventArgs e)
        {
        ...
        void MostrarInfo()
        {
            ...
            DataTable dtresint = new DataTable();
            DataTable dtrestod = new DataTable();
            DataTable dtinspro = new DataTable();
            DataTable dtinsint = new DataTable();
            DataTable dtinstod = new DataTable();

            CN_ges_planabastecimiento o_plapro = new CN_ges_planabastecimiento();
            ...
            o_plapro.PlanAbastecimientoUnificado();                     // CARGAMOS PLAN DE ABASTECIMIENTO UNFIFIADO
            dtrespro = o_plapro.dtLista;
            dtresint = o_plapro.dtLista2;
            dtrestod = o_plapro.dtLista3;
            dtinspro = o_plapro.dtLista4;
            dtinsint = o_plapro.dtLista5;
            dtinstod = o_plapro.dtLista6;
            ...
            {
                MessageBox.Show("¡ No se puede mostrar el plan de abastecimiento unificado por el siguiente motivo: " + o_plapro.c_ErrorMensaje + " !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
            }
            o_plapro = null;
        }
        void MostrarCabeceraMes(int n_MesInicio, DataTable dtrespro, DataTable dtinspro, DataTable dtresint, DataTable dtinsint, DataTable dtrestod, DataTable dtinstod)
        {
            int n_col = 0;
            int n_posArray = 3;
            ...
            funFlex.FlexMostrarDatos(FgProd, arrCabeceraFlex1, dtrespro, 2, true);
            funFlex.FlexMostrarDatos(FgProdIns, arrCabeceraFlex1, dtinspro, 2, true);

            funFlex.FlexMostrarDatos(FgInter, arrCabeceraFlex1, dtresint, 2, true);
            funFlex.FlexMostrarDatos(FgInterIns, arrCabeceraFlex1, dtinsint, 2, true);

            funFlex.FlexMostrarDatos(FgTodo, arrCabeceraFlex1, dtrestod, 2, true);
            funFlex.FlexMostrarDatos(FgTodoIns, arrCabeceraFlex1, dtinstod, 2, true);
        }
        ...
        {
            this.Text = "GESTION - Plan de Abastecimiento Unificado";
            this.Height = 600;
            this.Width = 1000;
        ...
        void ConfigurarFlex()
        {
            ...
            funFlex.FlexMostrarDatos(FgProd, arrCabeceraFlex1, dtEmpresa, 2, false);
            funFlex.FlexMostrarDatos(FgProdIns, arrCabeceraFlex1, dtEmpresa, 2, false);
            funFlex.FlexMostrarDatos(FgInter, arrCabeceraFlex1, dtEmpresa, 2, false);
            funFlex.FlexMostrarDatos(FgInterIns, arrCabeceraFlex1, dtEmpresa, 2, false);
            funFlex.FlexMostrarDatos(FgTodo, arrCabeceraFlex1, dtEmpresa, 2, false);
            funFlex.FlexMostrarDatos(FgTodoIns, arrCabeceraFlex1, dtEmpresa, 2, false);
        }
        private void ToolSalir_Click(object sender, EventArgs e)
        {
            this.Close();
        }
        private void FrmPlanAbastecimientoUni_Resize(object sender, EventArgs e)
        {
            Tab_Dimensionar(Tab1, this.Height - 83, this.Width - 18);
        }
    }
