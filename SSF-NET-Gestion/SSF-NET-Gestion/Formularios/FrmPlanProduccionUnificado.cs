...
{
    public partial class FrmPlanProduccionUnificado : Form
    {
        // VARIABLES PUBLICAS
        ...
        public FrmPlanProduccionUnificado()
        {
            InitializeComponent();
        }

        private void FrmPlanProduccionUnificado_Load(object sender, EventArgs e)
        {
            booAgregando = true;
            CargarCombos();
        ...
        private void FrmPlanProduccionUnificado_Activated(object sender, EventArgs e)
        {
        ...
        void MostrarInfo()
        {
            ...
            TabDet2.SelectedIndex = 0;
            FgProEmp1.Rows.Count = 2;
            o_plapro.PlanProduccionUnificado();                     // CARGAMOS PLAN DE VENTAS UNFIFIADO
            dtres = o_plapro.dtLista;
            ...
            {
                MessageBox.Show("¡ No se puede mostrar el plan de produccion unificado por el siguiente motivo: " + o_plapro.c_ErrorMensaje + " !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
            }
            o_plapro = null;
        }
        void MostrarCabeceraMes(int n_MesInicio, DataTable dtDatos,  DataTable dtDatos2)
        {
            int n_col = 0;
            int n_posArray = 3;
            ...
            funFlex.FlexMostrarDatos(FgIntEmp1, arrCabeceraFlex1, dtDatos2, 2, true);
        }
        ...
        {
            this.Text = "GESTION - Plan de Produccion Unificado";
            this.Height = 600;
            this.Width = 1000;
        ...
        private void FrmPlanProduccionUnificado_Resize(object sender, EventArgs e)
        {
            Tab_Dimensionar(Tab1, this.Height - 83, this.Width - 18);
        }
    }
