...
{
    public partial class FrmAnalisisCompra : Form
    {
        // VARIABLES PUBLICAS
        ...
        CN_ges_plancompras objCabecera = new CN_ges_plancompras();                            // CABECERA DEL REGISTRO
        ...
        private void FrmAnalisisCompra_Load(object sender, EventArgs e)
        {
        ...
        void ConfigurarFormulario()
        {
            ...
            if (n_Libro == 8) { this.Text = "GESTION - ANALISIS DE LAS COMPRAS"; }
            if (n_Libro == 32) { this.Text = "GESTION - ANALISIS DE RENTA DE 4TA CATEGORIA"; }
        ...
        private void FrmAnalisisCompra_Resize(object sender, EventArgs e)
        {
            Sz1.Left = 0;
            Sz1.Top = 41;
            Sz1.Height = this.Height - 83;
