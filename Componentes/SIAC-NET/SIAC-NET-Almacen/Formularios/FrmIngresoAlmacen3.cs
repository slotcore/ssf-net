...
{
    public partial class FrmIngresoAlmacen3 : DevComponents.DotNetBar.Metro.MetroAppForm
    {
        // VARIABLES PUBLICAS
        ...
        CN_mae_almdoc ObjAlmDoc = new CN_mae_almdoc();
        ...
        void DataTableCargar()
        {
            ...
            ObjAlmDoc.ListarEmpAlm(STU_SISTEMA.EMPRESAID, 1);               // 1 FILTRAREMOS SOLO LOS ALMACENES QUE PERTENESCAN A LA EMPRESA Y QUE GENEREN MOVIMIENTO DE INGRESO A ALMACEN 
        ...
        private void CboAlmacen_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            int n_Idlm = Convert.ToInt16( CboAlmacen.SelectedValue);
