...
namespace SIAC_Entidades.Estacionamiento
{
    public class BE_EST_LOCALSETUP
    {
        ...
        private int _n_vispre;
        private int _n_idserhor;
        private int _n_tolmin;
        public int n_idloc
        {
            get { return _n_idloc; }
            set { _n_idloc = value; }
        ...
        public int n_vispre
        {
            get { return _n_vispre; }
            set { _n_vispre = value; }
        }
        public int n_idserhor
        {
            get { return _n_idserhor; }
            set { _n_idserhor = value; }
        }
        public int n_tolmin
        {
            get { return _n_tolmin; }
            set { _n_tolmin = value; }
        }
    }
}
