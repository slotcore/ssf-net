...
{
    public partial class FrmManPuestos : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_coo_puestos objRegistros = new CN_coo_puestos();
        CN_sys_formulariovista objFormVis = new CN_sys_formulariovista();
        CN_coo_puestostipo objPueTip = new CN_coo_puestostipo();
        ...
        // ENTIDADES LOCALES
        BE_COO_PUESTOS BE_ListaReg = new BE_COO_PUESTOS();
        BE_COO_PUESTOS BE_Registro = new BE_COO_PUESTOS();

        // DATATABLE LOCALES
        DataTable dtRegistros = new DataTable();
        DataTable dtTipPue = new DataTable();
        ...
        public FrmManPuestos()
        {
            InitializeComponent();
        }

        private void FrmManPuestos_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void CargarCombos()
        {
            ...
            funDatos.ComboBoxCargarDataTable(CboTipPue, dtTipPue, "n_id", "c_des");
        }
        ...
        void DataTableCargar()
        {
            ...
            dtForm = objForm.TraerRegistro(41);
            ...
            objFormVis.ObtenerCabeceraLista(41, ref arrCabeceraDg1);

            objPueTip.mysConec = mysConec;
            dtTipPue = objPueTip.Listar(STU_SISTEMA.EMPRESAID);
        }
        void ListarItems()
        {
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            CboTipPue.SelectedValue = BE_Registro.n_idtippue;
            TxtDes.Text = BE_Registro.c_puesto;
        }
        void Nuevo()
        {
            n_QueHace = 1;
        ...
        void Blanquea()
        {
            CboTipPue.SelectedValue = 0;
            TxtDes.Text = "";
            TxtPrefijo.Text = "";
        }
        void Bloquea()
        {
            CboTipPue.Enabled = !CboTipPue.Enabled;
        ...
        bool CamposOK()
        {
            ...
            //if (TxtPrefijo.Text == "")
            //{
            //    MessageBox.Show("¡ No ha especificado el prefijo para el tipo de existencia !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
            //    booEstado = false;
            //    return booEstado;
            //}
            return booEstado;
        ...
        private void FrmManPuestos_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManPuestos_Resize(object sender, EventArgs e)
        {
