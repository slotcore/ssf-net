...
{
    public partial class FrmManConceptos : Form
    {
        // VARIABLES PUBLICAS
        ...
        public FrmManConceptos()
        {
            InitializeComponent();
        }

        private void FrmManConceptos_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            TxtImp.Text = BE_Registro.n_imp.ToString("0.00");
        ...
        private void FrmManConceptos_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManConceptos_Resize(object sender, EventArgs e)
        {
