...
namespace SIAC_DATOS.Models.Contabilidad
{
    ...
    public class CostoProduccionMovimiento : ObjectBase
    {
        #region constructor
        public CostoProduccionMovimiento()
        {
            _IsNew = true;
        }
        ...
        public static List<CostoProduccionMovimiento> FetchList(int n_idemp, int n_anotra)
        {
            List<CostoProduccionMovimiento> m_listentidad = new List<CostoProduccionMovimiento>();
                    ...
                    ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                using (MySqlCommand command = new MySqlCommand())
                {
                    ...
                    command.CommandText = "con_costoprodmov_listar";
                    ...
                    using (MySqlDataReader reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            CostoProduccionMovimiento m_entidad = SetObject(reader);
        ...
        public static CostoProduccionMovimiento Fetch(int id)
        {
            CostoProduccionMovimiento m_entidad = new CostoProduccionMovimiento();
                    ...
                    ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString))
            {
                using (MySqlCommand command = new MySqlCommand())
                {
                    command.Connection = connection;
                    command.CommandType = System.Data.CommandType.StoredProcedure;
                    command.CommandText = "con_costoprodmov_traerregistro";
                ...
                using (MySqlTransaction transaction = connection.BeginTransaction())
                {
                    using (MySqlCommand command = connection.CreateCommand())
                    {
                        try
                        {
                            command.Transaction = transaction;
                            command.CommandType = System.Data.CommandType.StoredProcedure;
                            command.CommandText = "con_costoprodmov_actualizar";
                            AddParameters(command);
                            int rows = command.ExecuteNonQuery();
                            transaction.Commit();
                        }
                ...
                using (MySqlTransaction transaction = connection.BeginTransaction())
                {
                    using (MySqlCommand command = connection.CreateCommand())
                    {
                        try
                        {
                            command.Transaction = transaction;
                            command.CommandType = System.Data.CommandType.StoredProcedure;
                            command.CommandText = "con_costoprodmov_eliminar";
        ...
        private static CostoProduccionMovimiento SetObject(MySqlDataReader reader)
        {
            return new CostoProduccionMovimiento
            {
