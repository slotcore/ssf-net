...
namespace SIAC_DATOS.Cooperativa
{
    public class CD_coo_socios
    {
        ...
        public DataTable Listar(int n_IdEmpresa)
        {
            ...
            DtResultado = xMiFuncion.StoreDTLLenar("coo_socios_select", arrParametros, mysConec);
        ...
        public DataTable TraerRegistro(int n_IdRegistro)
        {
            ...
            DtResultado = xMiFuncion.StoreDTLLenar("coo_socios_obtenerregistro", arrParametros, mysConec);
        ...
        public bool Insertar(BE_COO_SOCIOS entSocio)
        {
            ...
            if (xMiFuncion.StoreEjecutar("coo_socios_insertar", entSocio, mysConec, 1) == true)
            {
                booOk = true;
            }
            else
        ...
        public bool Actualizar(BE_COO_SOCIOS entSocio)
        {
            ...
            if (xMiFuncion.StoreEjecutar("coo_socios_actualizar", entSocio, mysConec, null) == true)
            {
                booOk = true;
            }
            else
        ...
        public bool Eliminar(int n_IdItem)
        {
            ...
            booResult = xMiFuncion.StoreEjecutar("coo_socios_delete", arrParametros, mysConec);
