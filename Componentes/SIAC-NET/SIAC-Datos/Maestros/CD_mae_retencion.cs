...
namespace SIAC_DATOS.Maestros
{
    public class CD_mae_retencion
    {
        ...
        public bool Insertar(BE_MAE_RETENCION entRetencion)
        {
            ...
            if (xMiFuncion.StoreEjecutar("mae_retencion_insert", entRetencion, mysConec, 0) == true)
            {
                booOk = true;
            }
            else
        ...
        public bool Modificar(BE_MAE_RETENCION entRetencion)
        {
            bool booOk = false;
            DatosMySql xMiFuncion = new DatosMySql();
            if (xMiFuncion.StoreEjecutar("mae_retencion_update", entRetencion, mysConec, 0) == true)
            {
                booOk = true;
            }
            else
        ...
        {
            Genericas xMiFuncion = new Genericas();
