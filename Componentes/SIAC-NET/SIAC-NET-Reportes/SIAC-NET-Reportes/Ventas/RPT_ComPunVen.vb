...
Public Class RPT_ComPunVen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIAC_NET_Reportes.RPT_ComPunVen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_ComPunVen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_ComPunVen = New RPT_ComPunVen()
        rpt.Site = Me.Site
        Return rpt
    End Function
