...
namespace Helper
{
    public class Cls_NumeroLetra
    {
        ...
        public String Convertir(String numero, bool mayusculas, string c_MonedaDescripcion)
        {
            String literal = "";
            ...
            if (mc.Count > 0)
            {
                ...
                parte_decimal = "con " + Num[1] + "/100 " + c_MonedaDescripcion;
