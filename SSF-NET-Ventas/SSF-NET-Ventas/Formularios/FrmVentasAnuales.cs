...
{
    public partial class FrmVentasAnuales : Form
    {
        // VARIABLES PUBLICAS
        ...
        public FrmVentasAnuales()
        {
            InitializeComponent();
        }

        private void FRmVentasAnuales_Load(object sender, EventArgs e)
        {
        ...
        void ConfigurarFormulario()
        {
            ...
            this.Text = "VENTAS - VENTAS ANUALES";
        ...
        private void OptImp_CheckedChanged(object sender, EventArgs e)
        {
