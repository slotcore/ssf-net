...
{
    public partial class FrmManVendedor : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_vta_vendedor objRegistros = new CN_vta_vendedor();
        ...
        // ENTIDADES LOCALES
        BE_VTA_VENDEDOR BE_ListaReg = new BE_VTA_VENDEDOR();
        BE_VTA_VENDEDOR BE_Registro = new BE_VTA_VENDEDOR();
        ...
        private void FrmManVendedor_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            TxtPorcentaje.Text = BE_Registro.n_porcom.ToString("0.00");
            TxtBasico.Text = BE_Registro.n_impbas.ToString("0.00");
        ...
        void Bloquea()
        {
            ...
            TxtBasico.Enabled = !TxtBasico.Enabled;
        }
        void ActivarTool()
        {
        ...
        void AsignarEntidad()
        {
            ...
            BE_ListaReg.n_impbas = Convert.ToDouble(TxtBasico.Text);
            BE_ListaReg.n_porcom = Convert.ToDouble(TxtPorcentaje.Text);
        ...
        bool CamposOK()
        {
            ...
            if (TxtBasico.Text == "")
            {
                MessageBox.Show("¡ No ha especificado el importe basico !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            if (TxtPorcentaje.Text == "")
            {
                MessageBox.Show("¡ No ha especificado el porcentaje de la comision !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            return booEstado;
        ...
        private void FrmManVendedor_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManVendedor_Resize(object sender, EventArgs e)
        {
        ...
        private void TxtBasico_Validated(object sender, EventArgs e)
        {
            if (TxtBasico.Text != "")
            {
                TxtBasico.Text = Convert.ToDouble(TxtBasico.Text).ToString("0.00");
            }
        }
        ...
        private void TxtPorcentaje_Validated(object sender, EventArgs e)
        {
            if (TxtPorcentaje.Text != "")
            {
                TxtPorcentaje.Text = Convert.ToDouble(TxtPorcentaje.Text).ToString("0.00");
            }
        }
    }
}
