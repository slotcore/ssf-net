...
{
    public partial class FrmManChoferes : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_vta_chofer objRegistros = new CN_vta_chofer();
        CN_sys_formulariovista objFormVis = new CN_sys_formulariovista();
        
        CN_sys_formulario objForm = new CN_sys_formulario();
        CN_vta_vehiculo objVehiculo = new CN_vta_vehiculo();
        ...
        // ENTIDADES LOCALES
        BE_VTA_CHOFER BE_ListaReg = new BE_VTA_CHOFER();
        BE_VTA_CHOFER BE_Registro = new BE_VTA_CHOFER();
        ...
        public FrmManChoferes()
        {
            InitializeComponent();
        }
        private void FrmManChoferes_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        {
            DataTableCargar();
            funDatos.ComboBoxCargarDataTable(CboEmpleado, dtEmpleado, "n_id", "c_apenom");
            funDatos.ComboBoxCargarDataTable(CboVehiculo, dtVehiculo, "n_id", "c_vehiculo");
        }
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(17, ref arrCabeceraDg1);
            ...
            objVehiculo.mysConec = mysConec;
            dtVehiculo = objVehiculo.Listar(STU_SISTEMA.EMPRESAID);

            objForm.mysConec = mysConec;                                    // CARGAMOS LOS DATOS DEL FORMULARIO
            dtForm = objForm.TraerRegistro(17);
        }
        void ListarItems()
        {
        ...
        void Bloquea()
        {
            ...
            TxtCat.Enabled = !TxtCat.Enabled;
            TxtNumBre.Enabled = !TxtNumBre.Enabled;
            CboVehiculo.Enabled = !CboVehiculo.Enabled;
        }
        void ActivarTool()
        {
        ...
        void AsignarEntidad()
        {
            ...
            BE_ListaReg.n_idper = Convert.ToInt16(CboEmpleado.SelectedValue);
            BE_ListaReg.n_id = BE_Registro.n_id;
            BE_ListaReg.c_cat = TxtCat.Text;
            BE_ListaReg.c_numbre = TxtNumBre.Text;
            BE_ListaReg.n_idveh = Convert.ToInt16(CboVehiculo.SelectedValue);
        }
        bool CamposOK()
        {
            bool booEstado = true;

            if (Convert.ToInt16(CboEmpleado.SelectedValue) == 0)
            {
            ...
            if (TxtCat.Text == "")
            {
                MessageBox.Show("¡ No ha especificado la categoria del brevete !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            if (TxtNumBre.Text == "")
            {
                MessageBox.Show("¡ No ha especificado el numero de brevete !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            if (Convert.ToInt16(CboVehiculo.SelectedValue) == 0)
            {
                MessageBox.Show("¡ No ha especificado el vehiculo que se le asignara al chofer !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            return booEstado;
        ...
        private void FrmManChoferes_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManChoferes_Resize(object sender, EventArgs e)
        {
