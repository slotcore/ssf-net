...
{
    public partial class FrmManMotTraslado : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_sun_motivotraslado objRegistros = new CN_sun_motivotraslado();
        ...
        // ENTIDADES LOCALES
        BE_SUN_MOTIVOTRASLADO BE_ListaReg = new BE_SUN_MOTIVOTRASLADO();
        BE_SUN_MOTIVOTRASLADO BE_Registro = new BE_SUN_MOTIVOTRASLADO();
        ...
        public FrmManMotTraslado()
        {
            InitializeComponent();
        }

        private void FrmManMotTraslado_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(19, ref arrCabeceraDg1);

            objForm.mysConec = mysConec;                                    // CARGAMOS LOS DATOS DEL FORMULARIO
            dtForm = objForm.TraerRegistro(19);
        }
        void ListarItems()
        {
        ...
        private void FrmManMotTraslado_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManMotTraslado_Resize(object sender, EventArgs e)
        {
