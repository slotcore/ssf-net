...
{
    public partial class FrmManItemsCEN : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_vta_itemcen objRegistros = new CN_vta_itemcen();
        ...
        // ENTIDADES LOCALES
        BE_VTA_ITEMCEN BE_ListaReg = new BE_VTA_ITEMCEN();
        BE_VTA_ITEMCEN BE_Registro = new BE_VTA_ITEMCEN();
        ...
        public FrmManItemsCEN()
        {
            InitializeComponent();
        }

        private void FrmManItemsCEN_Load(object sender, EventArgs e)
        {
            booAgregando = true;
            CargarCombos();
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            TxtDescCEN.Text = BE_Registro.c_descen.ToString();
            CboItem.SelectedValue = Convert.ToInt32(BE_Registro.n_iditem);
        ...
        void Bloquea()
        {
            ...
            TxtDescCEN.Enabled = !TxtDescCEN.Enabled;
        ...
        void AsignarEntidad()
        {
            ...
            BE_ListaReg.n_idcli = Convert.ToInt32(CboCliente.SelectedValue);
            BE_ListaReg.n_id = BE_Registro.n_id;
            BE_ListaReg.c_codcen = TxtCodCEN.Text;
            BE_ListaReg.c_descen = TxtDescCEN.Text;
            BE_ListaReg.n_iditem = Convert.ToInt32(CboItem.SelectedValue);
        }
        bool CamposOK()
        {
            bool booEstado = true;
            ...
            {
                MessageBox.Show("¡ No ha especificado el item !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            if (TxtCodCEN.Text == "")
            {
                MessageBox.Show("¡ No ha especificado el codigo CEN del item !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            if (TxtDescCEN.Text == "")
            {
                MessageBox.Show("¡ No ha especificado la descripcion CEN del item !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            return booEstado;
        ...
        private void FrmManItemsCEN_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManItemsCEN_Resize(object sender, EventArgs e)
        {
