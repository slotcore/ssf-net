...
{
    public partial class FrmManVehiculo : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_vta_vehiculo objRegistros = new CN_vta_vehiculo();
        ...
        // ENTIDADES LOCALES
        BE_VTA_VEHICULO BE_ListaReg = new BE_VTA_VEHICULO();
        BE_VTA_VEHICULO BE_Registro = new BE_VTA_VEHICULO();
        ...
        void DataTableCargar()
        {
            ...
            objFormVis.ObtenerCabeceraLista(18, ref arrCabeceraDg1);

            //objEmpleado.mysConec = mysConec;
            //dtEmpleado = objEmpleado.Listar(STU_SISTEMA.EMPRESAID);

            objForm.mysConec = mysConec;                                    // CARGAMOS LOS DATOS DEL FORMULARIO
            dtForm = objForm.TraerRegistro(18);
        }
        void ListarItems()
        {
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            TxtNumPlaca.Text = BE_Registro.c_numpla.ToString();
            TxtMarca.Text = BE_Registro.c_marca.ToString();
        ...
        void Bloquea()
        {
            ...
            TxtNumPlaca.Enabled = !TxtNumPlaca.Enabled;
        ...
        void AsignarEntidad()
        {
            ...
            BE_ListaReg.c_marca = TxtMarca.Text;
            BE_ListaReg.c_numpla = TxtNumPlaca.Text;
        ...
        bool CamposOK()
        {
            ...
            if (TxtMarca.Text == "")
            {
                MessageBox.Show("¡ No ha especificado la marca del vehiculo !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            if (TxtNumPlaca.Text == "")
            {
                MessageBox.Show("¡ No ha especificado el numero de placa del vehiculo !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            return booEstado;
        }
        private void FrmManVehiculo_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManVehiculo_Resize(object sender, EventArgs e)
        {
