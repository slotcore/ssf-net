...
{
    public partial class FrmManMotivos : Form
    {
        // VARIABLES PUBLICAS
        ...
        // OBJETOS LOCALES
        CN_mae_motivos objRegistros = new CN_mae_motivos();
        ...
        // ENTIDADES LOCALES
        BE_MAE_MOTIVOS BE_ListaReg = new BE_MAE_MOTIVOS();
        BE_MAE_MOTIVOS BE_Registro = new BE_MAE_MOTIVOS();
        ...
        public FrmManMotivos()
        {
            InitializeComponent();
        }

        private void FrmManMotivos_Load(object sender, EventArgs e)
        {
            CargarCombos();
        ...
        void DataTableCargar()
        {
            ...
            dtRegistros = objRegistros.Listar(0,2);

            objFormVis.mysConec = mysConec;                                      // CARGAMOS EL ARRAY CON LOS DATOS PARA LA VISTA DE DgLista
            objFormVis.ObtenerCabeceraLista(89, ref arrCabeceraDg1);

            objForm.mysConec = mysConec;                                    // CARGAMOS LOS DATOS DEL FORMULARIO
            dtForm = objForm.TraerRegistro(89);
        }
        void ListarItems()
        {
        ...
        void VerRegistro(int n_IdRegistro)
        {
            ...
            TxtCodigo.Text = BE_Registro.n_id.ToString();
        }
        void Nuevo()
        {
            n_QueHace = 1;
        ...
        void AsignarEntidad()
        {
            ...
            BE_ListaReg.n_idmod = 2;
            BE_ListaReg.n_activo = 1;
        }
        bool CamposOK()
        {
            bool booEstado = true;
            ...
            if (TxtDes.Text == "")
            {
                MessageBox.Show("¡ No ha especificado la descripcion del motivo !", "", MessageBoxButtons.OK, MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                booEstado = false;
                return booEstado;
            }
            //if (TxtCodigo.Text == "")
        ...
        private void FrmManMotivos_Activated(object sender, EventArgs e)
        {
        ...
        private void FrmManMotivos_Resize(object sender, EventArgs e)
        {
